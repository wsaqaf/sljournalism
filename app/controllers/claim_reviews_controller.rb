class ClaimReviewsController < ApplicationController
  ...
  def save_to_the_blockchain
        ...
        argmnt="{\"Args\":[\"assessFactcheck\",\""+ENV['BLOCKCHAIN_ORGID']+"\",\""+@claim_review.blockchain_id.to_s+"\", \""+current_user.id.to_s+"\", \""+eval+"\", \""+params[:blockchain_assessment_rationale]+"\"]}"
  #{"Args":["assessFactcheck","org1","F3801204119137170340","1","approved", "Verifiable, clear and thorough factcheck. Well done!"]}
